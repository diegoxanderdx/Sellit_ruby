...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'render a list of products filtered by a price range' do
  ...
  test 'doesnt allow to create a new product with empty fields' do
    post products_path, params: {
      product:{
        title: 'redmi',
        description: '',
  ...
  test 'renders an edit product form' do
